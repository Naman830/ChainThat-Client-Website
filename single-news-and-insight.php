<?php
/**
 * The template for displaying single news and insight posts
 *
 * @package ChainThat
 * @version 1.0.0
 */
...
<section class="news-single-area">
    <div class="container">
        <div class="news-single-main">
            ...
            <div class="breadcrumb-section wow fadeInLeft">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo esc_url(get_post_type_archive_link('news_and_insight')); ?>">News & Insights</a>
                        </li>
            ...
            if ($featured_image): ?>
                <div class="news-single-featured-image wow fadeInUp">
                    <img src="<?php echo esc_url($featured_image); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" class="img-fluid">
                </div>
            <?php endif; ?>

            <!-- Post Content -->
            <div class="news-single-content wow fadeInUp">
...
<section class="back-to-archive-area">
    <div class="container">
        <div class="back-to-archive wow fadeInUp">
            <div class="btn-all">
                <a href="<?php echo esc_url(get_post_type_archive_link('news_and_insight')); ?>">
                    <i class="fas fa-arrow-left"></i> Back to News & Insights
                </a>
            </div>
        </div>
    </div>
